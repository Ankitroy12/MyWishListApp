...
import ankit.app.mywishlistapp.data.Wish
...
fun AddEditDetailView(
    ...
    Scaffold(
        ...
        Column(
            ...
            WishTextField(
                label = "Title" , value = viewModel.wishTitleState, onValueChange = {
            ...
            WishTextField(
                label = "Description" , value = viewModel.wishDescriptionState, onValueChange = {
